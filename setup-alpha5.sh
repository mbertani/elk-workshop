...
# "https://download.elasticsearch.org/elasticsearch/release/org/elasticsearch/distribution/tar/elasticsearch/2.4.0/elasticsearch-2.4.0.tar.gz"
...
#"https://download.elastic.co/kibana/kibana/kibana-4.6.0-linux-x64.tar.gz"
else
...
#"https://download.elastic.co/kibana/kibana/kibana-4.6.0-linux-x86.tar.gz"
fi
